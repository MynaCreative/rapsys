s<template>
    <Layout>
        <Head title="SMU" />
        <template #header>
            <PageHeader title="SMU" :breadcrumbs="breadcrumbs" />
        </template>
        ...
        <div class="card">
            <form @submit.prevent="form.get(route(`${page.module}.smu`))" class="search-box">
                <input type="search" class="form-control search border-0 py-3" v-model="form.code" placeholder="Search SMU code here ..." autofocus>
        ...
        <div class="card" >
            <div class="card-body">
                ...
                <div class="text-muted fw-medium" v-else>example : <code>12662562183</code></div>
            </div>
        </div>
