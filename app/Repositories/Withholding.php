...
use App\Exports\Withholding\Resource as ModelExport;
use App\Imports\DataImport;
use App\Exports\Withholding\Sample as SampleTemplate;
...
class Withholding
{
     ...
     * @return Withholding
     */
    public static function init(Model $model): Withholding
    {
        $instance = new self;
