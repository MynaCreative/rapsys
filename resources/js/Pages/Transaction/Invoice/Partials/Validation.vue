            ...
            <table class="table table-sm">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-end">{{ validationReference.count.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }) }}</td>
                        <td class="text-end">{{ validationReference.weight.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }) }}</td>
                    </tr>
                    <tr>
                        <td>SMU</td>
                        <td>Validation Bill</td>
                        <td>Already Billed</td>
                        <td class="text-end">{{ validationBill.count.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }) }}</td>
                        <td class="text-end">{{ validationBill.weight.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }) }}</td>
                    </tr>
                    <tr>
                        <td>SMU</td>
                        <td>Validation Weight SMU/AWB</td>
                        <td>Weight Not Match</td>
                        <td class="text-end">{{ validationWeight.count.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }) }}</td>
                        <td class="text-end">{{ validationWeight.weight.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }) }}</td>
                    </tr>
                    <tr>
                        <td>SMU</td>
                        <td>Validation Scan Compliance</td>
                        <td>Scan Not Found</td>
                        <td class="text-end">{{ validationScanCompliance.count.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }) }}</td>
                        <td class="text-end">{{ validationScanCompliance.weight.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }) }}</td>
                    </tr>
                    <tr>
                        <td>SMU</td>
                        <td>Validation Ops Plan</td>
                        <td>Warning RPX Area</td>
                        <td class="text-end">{{ validationOpsPlan.count.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }) }}</td>
                        <td class="text-end">{{ validationOpsPlan.weight.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }) }}</td>
                    </tr>
                </tbody>
            </table>
