...
use App\Exports\InvoiceType\Resource as ModelExport;
use App\Imports\DataImport;
use App\Exports\InvoiceType\Sample as SampleTemplate;
...
class InvoiceType
{
     ...
     * @return InvoiceType
     */
    public static function init(Model $model): InvoiceType
    {
        $instance = new self;
