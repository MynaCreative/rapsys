s<template>
    <Layout>
        <Head title="AWB Batch" />
        <template #header>
            <PageHeader title="AWB Batch" :breadcrumbs="breadcrumbs" />
        </template>
        ...
        <div class="card">
            <form @submit.prevent="form.get(route(`${page.module}.awb-batch`))" class="search-box">
                <input type="search" class="form-control search border-0 py-3" v-model="form.code" placeholder="Search AWB code here, for multiple code separeted using comma ','" autofocus>
