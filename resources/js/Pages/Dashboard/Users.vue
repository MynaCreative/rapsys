    ...
    <div class="card card-height-100">
        <div class="card-header align-items-center d-flex">
            ...
            <div class="flex-shrink-0">
                ...
                <a class="text-reset dropdown-btn" href="javascript:void(0);" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="card-body">
            <apexchart class="apex-charts" dir="ltr" height="219" :series="chartSeries" :options="chartOptions"></apexchart>
...
watchEffect(() => {
    chartSeries.value = [78.56, 105.02, 42.89]
})
