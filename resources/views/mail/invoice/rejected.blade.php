...
@section('content')
    ...
    <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px; color: #555555;">Your {{ $title }} <a href="{{ url(route('notifications.invoice-receipts', $data['id'])) }}" style="color:#1c1958;font-weight:bold;text-decoration: underline">{{ $data['code'] }}</a> has been rejected.</p>
