...
class ExpenseValidation implements ShouldQueue
{
    ...
    public function summaryAWB($expense)
    {
        $expense->update([
            ...
            'total_valid_amount' => $expense->awbItems->where('validation_reference', 1)->sum('amount_after_tax'),
            'total_invalid_amount' => $expense->awbItems->where('validation_reference', 0)->sum('amount_after_tax'),

            'total_valid_amount_validation_reference' => $expense->awbItems->where('validation_reference', 1)->sum('amount_after_tax'),
            'total_valid_amount_validation_weight' => $expense->awbItems->where('validation_weight', 1)->sum('amount_after_tax'),
            'total_valid_amount_validation_scan_compliance' => $expense->awbItems->where('validation_scan_compliance', 1)->sum('amount_after_tax'),
            'total_valid_amount_validation_ops_plan' => $expense->awbItems->where('validation_ops_plan', 1)->sum('amount_after_tax'),
            'total_valid_amount_validation_bill' => $expense->awbItems->where('validation_bill', 1)->sum('amount_after_tax'),

            'total_invalid_amount_validation_reference' => $expense->awbItems->where('validation_reference', 0)->sum('amount_after_tax'),
            'total_invalid_amount_validation_weight' => $expense->awbItems->where('validation_weight', 0)->sum('amount_after_tax'),
            'total_invalid_amount_validation_scan_compliance' => $expense->awbItems->where('validation_scan_compliance', 0)->sum('amount_after_tax'),
            'total_invalid_amount_validation_ops_plan' => $expense->awbItems->where('validation_ops_plan', 0)->sum('amount_after_tax'),
            'total_invalid_amount_validation_bill' => $expense->awbItems->where('validation_bill', 0)->sum('amount_after_tax'),
