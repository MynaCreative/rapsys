                ...
                <div class="table-responsive table-card mb-0">
                    <table class="table table-hover table-nowrap align-middle mb-0">
                        <thead class="table-light text-muted">
                            <tr>
                                <th width="60">#</th>
                                <Sort label="Service Type" attribute='service_type'/>
                                <Sort label="Origin City" attribute='origin_city'/>
                                <Sort label="Origin Station" attribute='origin_station'/>
                                <Sort label="Dest City" attribute='dest_city'/>
                                <Sort label="Dest Station" attribute='dest_station'/>
                                <Sort label="Pickup Served By" attribute='pick_up_served_by'/>
                                <Sort label="Delivery Served By" attribute='delivery_served_by'/>
                                <Sort label="Scan Dest" attribute='scan_dest'/>
                                <Sort label="Hub Station Dest" attribute='hub_station_dest'/>
                        ...
                        <tbody>
                            <tr v-for="item, index in collection.data" :key="item.id">
                                ...
                                <td>{{ item.dest_station }}</td>
                                <td>{{ item.pick_up_served_by }}</td>
                                <td>{{ item.delivery_served_by }}</td>
                                <td>{{ item.scan_dest }}</td>
                                <td>{{ item.hub_station_dest }}</td>
